export const siteConfig = {
  name: "Section Eight",
  title: "Section Eight - Modern Tech for Nigeria",
  shortTitle: "Section Eight",
  description:
    "Shop premium and budget-friendly tech in Nigeria. Phones, laptops, accessories, gaming gear and more. Secured payment at checkout.",
  url: process.env.NEXT_PUBLIC_APP_URL || "https://sectioneight.ng",
  ogImageAlt: "Section Eight - Nigeria's smartest tech marketplace",
};
